...
const content4 = {
  hero: {
    title: "Paddle Wheel Flowmeter for Water Flow Measurement – Supplier in Pune",
    description:
    ...
    image: "/paddle_wheel_supplier.webp" // Update this path to your hero image
  },
  toc: [
  ...
  sections: {
    ...
    applications: {
      title: "Applications of Paddle Wheel Flowmeters for Water Flow Measurement",
      list: [
      ...
      items: [
        {
          ...
          answer: "They are widely used in water treatment, manufacturing, HVAC, fire protection, and municipal water distribution."
        },
        {
          question: "2. Why choose an RS485 paddle wheel flowmeter?",
          answer: "RS485 communication allows long-distance data transmission and integration with SCADA, PLC, and IoT-based monitoring systems."
        },
        {
          question: "3. Are paddle wheel flowmeters suitable for high-pressure applications?",
          answer: "Yes, but ensure the material and pressure rating match your system's specifications."
        },
        {
          question: "4. How do I install a paddle wheel flowmeter?",
          answer: "They are installed inline in the pipeline, ensuring proper alignment with the flow direction."
        },
        {
          question: "5. Where can I buy paddle wheel flowmeters in Pune?",
          answer: "You can buy from trusted suppliers like [Your Company Name] offering high-quality, industrial-grade flow sensors."
        }
      ]
    },
    conclusion: {
